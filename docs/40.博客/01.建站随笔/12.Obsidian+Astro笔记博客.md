---
title: 怎么使用 Obsidian 来编写 Astro 博客
date: 2026-04-18
updated: 2026-04-18
permalink: /blog/obsidian-astro
categories:
  - 博客
  - 建站随笔
tags:
...
top: false
sticky: 0
description: 本教程专为「Obsidian 撰写笔记」+「Astro Composer 插件转换笔记为 Astro 博客内容」+「Git 插件同步到 GitHub」的 workflow 设计，全程无需复杂命令行，纯 Obsidian 内操作。
---
